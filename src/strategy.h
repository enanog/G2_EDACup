...
class StrategyManager {
  private:
     ...
     */
    void executeInterceptor(Robot& bot, const Ball& ball) const;

    /**
     * @brief Execute defender behavior
     * Protects own goal with three alert levels
     */
    void executeDefender(Robot& bot,
                         const Ball& ball,
     ...
     */
    void executeSupport(GameState& gamestate_g,
                        Robot& bot,
     ...
     */
    void executeAttacker(Robot& bot,
                         const Robot& teammate,
                         const Ball& ball) const;
     ...
     */
    void executeCamper(Robot& bot) const;
